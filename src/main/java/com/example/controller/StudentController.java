...
public class StudentController {
	...
	public List<StudentResponse> getAllStudents() {
		//StudentResponse studentResponse = new StudentResponse(1,"Anup", "Katuwal");
	...
	public StudentResponse updateStudent(@Valid @RequestBody UpdateStudentRequest updateStudentRequest ) {
		Student student = studentService.updateStudnet(updateStudentRequest);
		return new StudentResponse(student);
	}
	/*
	...
	public List<StudentResponse> getByFirstName(@PathVariable String first_Name){
		List<Student> studentList = studentService.getByFirstName(first_Name);
		List<StudentResponse> studentResponseList = new ArrayList<StudentResponse>();
		studentList.stream().forEach(student ->{
			studentResponseList.add(new StudentResponse(student));
		});
	...
	public StudentResponse getByFirstNameLastName(@PathVariable String firstName,
